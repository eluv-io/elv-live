        ...
        <nav className="header__nav header__nav--links desktop">
          ...
          <MenuButton
            ...
            items={[
              ...
              {label: mainStore.l10n.header.creator_studio, to: "/content-fabric/creator-studio", props: {useNavLink: true, exact: true}},
              {label: mainStore.l10n.header.analytics, to: "/content-fabric/analytics", props: {useNavLink: true, exact: true}},
              {label: mainStore.l10n.header.ai_clip_search, to: "/content-fabric/ai-clip-search", props: {useNavLink: true, exact: true}},
              {label: mainStore.l10n.header.video_editor, to: "/content-fabric/video-editor", props: {useNavLink: true, exact: true}},
              {label: mainStore.l10n.header.elv_media_wallet, to: "/content-fabric/media-wallet", props: {useNavLink: true, exact: true}},
              {label: mainStore.l10n.header.embeddable_player, to: "/content-fabric/embeddable-player", props: {useNavLink: true, exact: true}}
            ]}
          >
