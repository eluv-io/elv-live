          ...
          <div className="compatible-devices__autocomplete-results">
            ...
            <div className="compatible-devices__autocomplete-results-subheader">
              ...
              <div className="compatible-devices__item-links">
                <a href={AppleDeviceCSV} download="apple-tv.csv">Apple TV</a>
                <span className="compatible-devices__item-links-separator">|</span>
                <a href={AndroidDeviceCSV} download="android-tv.csv">Android TV</a>
                <span className="compatible-devices__item-links-separator">|</span>
                <a href={FireDeviceCSV} download="amazon-fire-tv.csv">Amazon Fire TV</a>
                <span className="compatible-devices__item-links-separator">|</span>
                <a href={XBOXDeviceCSV} download="xbox.csv">XBOX</a>
              </div>
            </div>
          </div> :
          <ul>
