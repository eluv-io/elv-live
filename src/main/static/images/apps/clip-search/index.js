...
export const ClipSearch4 = require("./04.jpg");
export const ClipSearch5 = require("./05.jpg");
export const ClipSearch6 = require("./06.jpg");
export const ClipSearch7 = require("./07.jpg");
export const ClipSearch8 = require("./08.jpg");
