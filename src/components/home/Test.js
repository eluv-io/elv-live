...
import MultiView from "../livestream/Stream/MultiView";
import MultiViewJson from '../livestream/Stream/example.json';
...
class Stream extends React.Component {
  ...
  render() {
    ...
    const setStream = (streamIndex) => {
      console.log("setStream", streamIndex);
    ...
    const handleSwitch = () => {
      ...
      if (this.state.switchValue === false) {
        this.setState({activeStream: 6});
      } else {
        this.setState({activeStream: 0});
      }
    }
