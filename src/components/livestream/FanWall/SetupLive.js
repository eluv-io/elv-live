onst { ElvClient } = require("../src/ElvClient.js")
​
/*
 * Usage:
...
const rtmpStream = {
  ...
  videoTxParams: {
    ...
    "seg_duration": "30",
    "video_seg_duration_ts": 480480,    //480480,    // 30*16000
    "video_bitrate": 20000000,          // 20 Mbps
  },
}
​
...
​
    ...
    await client.MergeMetadata({
      ...
      metadata: {
        ...
        "source_timescale2": conf.sourceTimescale2,
