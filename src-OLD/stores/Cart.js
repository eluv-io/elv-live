import { observable, action, flow, computed, toJS, makeObservable } from "mobx";
...
class CartStore {
  ...
  constructor(rootStore) {
    makeObservable(this, {
      currency: observable,
      showCartOverlay: observable,
      showTicketOverlay: observable,
      showCheckoutOverlay: observable,
      cartOverlayMessage: observable,
      ticketOverlayOptions: observable,
      email: observable,
      confirmationId: observable,
      tickets: observable,
      merchandise: observable,
      featuredTickets: observable,
      featuredMerchandise: observable,
      featuredDonations: observable,
      submittingOrder: observable,
      paymentServicePublicKeys: observable,
      purchasedTicketStartDate: observable,
      purchasedTicketEndDate: observable,
      lastAdded: observable,
      shippingCountries: computed,
      currencies: computed,
      SetCurrency: action.bound,
      ToggleCartOverlay: action.bound,
      ToggleTicketOverlay: action.bound,
      ToggleCheckoutOverlay: action.bound,
      UpdateEmail: action.bound,
      AddItem: action.bound,
      UpdateItem: action.bound,
      RemoveItem: action.bound,
      AddFeaturedItem: action.bound,
      RemoveFeaturedItem: action.bound,
      PaymentServerRequestParams: action.bound,
      StripeSubmit: action.bound,
      CoinbaseSubmit: action.bound,
      PaypalSubmit: action.bound,
      OrderComplete: action.bound,
