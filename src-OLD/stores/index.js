import { configure, observable, action, flow, runInAction, toJS, makeObservable } from "mobx";
...
class RootStore {
  ...
  constructor() {
    makeObservable(this, {
      ...
      baseKey: observable,
      walletKey: observable,
      client: observable,
      redeemedTicket: observable,
      error: observable,
      basePublicUrl: observable,
      walletClient: observable,
      frameClient: observable,
      walletTarget: observable,
      walletLoaded: observable,
      walletLoggedIn: observable,
      walletVisibility: observable,
      currentWalletState: observable,
      defaultWalletState: observable,
      savedTickets: observable,
      marketplaceParams: observable,
      SetApp: action.bound,
      LoadRedeemedTickets: action.bound,
      InitializeClient: action.bound,
      RedeemOffer: action.bound,
      RedeemCode: action.bound,
      RedeemCouponCode: action.bound,
      DestroyFrameClient: action.bound,
      ReloadWallet: action.bound,
      SetDefaultWalletState: action.bound,
      ResetDefaultWalletState: action.bound,
      CloseWalletModal: action.bound,
      SetWalletPanelVisibility: action.bound,
      LogIn: action.bound,
      SetError: action.bound,
      UpdateBaseKey: action.bound,
