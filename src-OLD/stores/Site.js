...
class SiteStore {
  ...
  constructor(rootStore) {
    makeObservable(this, {
      marketplaceOnly: observable,
      marketplaceNavigated: observable,
      mainSiteInfo: observable,
      baseSiteUrl: observable,
      tenantKey: observable,
      tenantSlug: observable,
      tenants: observable,
      featuredSitesLoaded: observable,
      carouselSitesLoaded: observable,
      eventSites: observable,
      siteSlug: observable,
      siteIndex: observable,
      darkMode: observable,
      marketplaceInfo: observable,
      streams: observable,
      showCheckout: observable,
      selectedTicket: observable,
      siteId: observable,
      siteHash: observable,
      marketplaceHash: observable,
      marketplaceId: observable,
      chatChannel: observable,
      error: observable,
      language: observable,
      viewers: observable,
      analyticsInitialized: observable,
      analyticsEvents: observable,
      client: computed,
      siteLoaded: computed,
      production: computed,
      availableTenants: computed,
      featuredSiteKeys: computed,
      carouselSiteKeys: computed,
      currentSite: computed,
      currentSiteInfo: computed,
      promos: computed,
      currentSiteTicket: computed,
      currentSiteTicketSku: computed,
      currentSiteMetadataPath: computed,
      dropEvents: computed,
      nextDrop: computed,
      nextDropEvent: computed,
      baseSitePath: computed,
      UpdateViewers: action.bound,
      SetLanguage: action.bound,
      SetCurrentDropEvent: action.bound,
      ChatChannel: action.bound,
      ToggleDarkMode: action.bound,
      Reset: action.bound,
      LoadMainSite: action.bound,
      LoadFeaturedSites: action.bound,
      LoadTenant: action.bound,
      LoadSite: action.bound,
      LoadStreamURI: action.bound,
      LoadDropStreamOptions: action.bound,
      ShowCheckoutModal: action.bound,
      CloseCheckoutModal: action.bound,
      InitializeAnalytics: action.bound,
      AddAnalyticsEvent: action.bound,
      ProcessAnalyticsEvents: action.bound,
      eventInfo: computed,
      artistBio: computed,
      ...
      sponsors: computed,
      merchTab: computed,
      streamPageInfo: computed,
      ticketClasses: computed
    });
